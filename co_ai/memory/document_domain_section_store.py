...
from co_ai.models.document_section_domain import DocumentSectionDomainORM
...
class DocumentSectionDomainStore:
    ...
    def insert(self, data: dict) -> DocumentSectionDomainORM:
        ...
        """
        stmt = pg_insert(DocumentSectionDomainORM).values(**data)
        ...
        if self.logger:
            self.logger.log("SectionDomainUpserted", data)
