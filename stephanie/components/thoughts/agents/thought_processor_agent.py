...
from stephanie.components.thoughts.vpm.thought_vpm_encoder import \
    ThoughtVPMEncoder
from stephanie.services.scoring_service import \
    ScoringService  # existing in your repo

from ..thought_trace import ThoughtTrace
from ..thought_types import Evidence, Thought, ThoughtKind
