...
This module provides FrontierLens, a structured analyzer that turns sequences of scored items
...
Core concepts:
  - FrontierLensEpisode: raw (items × metrics) score matrix + names
  - FrontierLensReport: global + regional statistics over a frontier metric
  - FrontierLens: high-level wrapper that builds a report + feature vector from rows/matrices
"""
