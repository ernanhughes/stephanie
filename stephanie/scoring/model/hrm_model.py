...
class RMSNorm(nn.Module):
    ...
    def __init__(self, dim: int, eps: float = 1e-6):
        ...
        logger.debug(f"RMSNorm initialized with dim={dim}, eps={eps}")
...
class RecurrentBlock(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, name="RecurrentBlock"):
        ...
        logger.debug(f"{self.name} initialized with input_dim={input_dim}, hidden_dim={hidden_dim}")
...
class InputProjector(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim):
        ...
        self.norm = RMSNorm(hidden_dim)
        logger.debug(f"InputProjector initialized with input_dim={input_dim}, hidden_dim={hidden_dim}")
...
class OutputProjector(nn.Module):
    ...
    def __init__(self, h_dim, output_dim):
        ...
        logger.debug(f"OutputProjector initialized with h_dim={h_dim}, output_dim={output_dim}")
...
class HRMModel(nn.Module):
    ...
    def __init__(self, cfg, logger=None):
        ...
        logger.debug(f"HRMModel initialized with input_dim={self.input_dim}, h_dim={self.h_dim}, l_dim={self.l_dim}, output_dim={self.output_dim}, n_cycles={self.n_cycles}, t_steps={self.t_steps}")
